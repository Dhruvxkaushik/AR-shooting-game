AFRAME.registerComponent("bullets", {
    ...
    removeBullet: function (e) {
      ...
      if (elementHit.id.includes("meteor")) {
        
        var countTankEl = document.querySelector("#scoreCount");
        var meteorsFired = parseInt(countTankEl.getAttribute("text").value);
        meteorsFired += 1;
        ...
        if (meteorsFired === 10) {
          var txt = document.querySelector("#gameWone");
